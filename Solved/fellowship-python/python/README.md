1. I have done this task on a laptop with Windows 10 (20H1), Python 3.10.x
2. You need to initialise the databse once by calling "./task init" in the "...fellowship-python/python" directory
3. Then everrything is as required.
4. This command line app passed only 6 test cases out of 16 present in the task.test.js file.
5. Most of them are due to way of handling errors.
6. Some of them are due to not clearing of completed tasks between test cases, as this app requires user to initialise a databse manually.
